...
func TestGetTrendingPodcasts(t *testing.T) {
	...
	exp := pb.Podcasts{
		Podcasts: []*pb.Podcast{
			{PodcastId: "04c70d01-930c-45b0-9e6e-161fc5f39175", Genre: []string{"philosophy"}},
			{PodcastId: "323e4567-e89b-12d3-a456-426614174002", Genre: []string{"education"}, ListenCount: 75, LikeCount: 25},
			{PodcastId: "923e4567-e89b-12d3-a456-426614174008", Genre: []string{"religion"}, ListenCount: 85, LikeCount: 40},
			{PodcastId: "523e4567-e89b-12d3-a456-426614174004", Genre: []string{"politics"}, ListenCount: 90, LikeCount: 45},
			{PodcastId: "223e4567-e89b-12d3-a456-426614174001", Genre: []string{"technology"}, ListenCount: 100, LikeCount: 50},
			{PodcastId: "723e4567-e89b-12d3-a456-426614174006", Genre: []string{"health"}, ListenCount: 95, LikeCount: 55},
			{PodcastId: "623e4567-e89b-12d3-a456-426614174005", Genre: []string{"business"}, ListenCount: 110, LikeCount: 60},
			{PodcastId: "a23e4567-e89b-12d3-a456-426614174009", Genre: []string{"technology"}, ListenCount: 105, LikeCount: 65},
			{PodcastId: "823e4567-e89b-12d3-a456-426614174007", Genre: []string{"sports"}, ListenCount: 130, LikeCount: 70},
			{PodcastId: "b23e4567-e89b-12d3-a456-426614174010", Genre: []string{"education"}, ListenCount: 125, LikeCount: 75},
			{PodcastId: "423e4567-e89b-12d3-a456-426614174003", Genre: []string{"philosophy"}, ListenCount: 120, LikeCount: 80},
		},
	}
