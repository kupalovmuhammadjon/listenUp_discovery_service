...
type EpisodeMetadataClient interface {
	...
	GetRecommendedPodcasts(ctx context.Context, in *Void, opts ...grpc.CallOption) (*Podcasts, error)
...
func (c *episodeMetadataClient) GetRecommendedPodcasts(ctx context.Context, in *Void, opts ...grpc.CallOption) (*Podcasts, error) {
	out := new(Podcasts)
...
type EpisodeMetadataServer interface {
	...
	GetRecommendedPodcasts(context.Context, *Void) (*Podcasts, error)
...
func (UnimplementedEpisodeMetadataServer) GetRecommendedPodcasts(context.Context, *Void) (*Podcasts, error) {
...
func _EpisodeMetadata_GetRecommendedPodcasts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EpisodeMetadataServer).GetRecommendedPodcasts(ctx, req.(*Void))
	}
	return interceptor(ctx, in, info, handler)
}
